...
public interface MerchantProductRepository extends JpaRepository<MerchantProduct, Long> {
     ...
     * @return 商品分页列表
     */
    Page<MerchantProduct> findByStatus(Integer status, Pageable pageable);

    /**
     * 根据状态和推荐状态查找所有商家的商品列表
     * 
     * @param status        商品状态
     ...
     * @return 商品分页列表
     */
    Page<MerchantProduct> findByStatusAndIsRecommended(Integer status, Integer isRecommended, Pageable pageable);
     ...
     * @return 商品分页列表
     */
    Page<MerchantProduct> findByMerchantIdAndProductNameContaining(Long merchantId, String productName,
            Pageable pageable);
     ...
     * merchantId为null时,搜索所有商家的商品。
     *
     * @param merchantId  商家ID(可为空,为空时搜索所有商家)
     ...
     * @return 商品分页列表
     */
    @Query("SELECT p FROM MerchantProduct p WHERE " +
    ...
    Long countLowStockProducts(@Param("merchantId") Long merchantId,
     ...
     */
    Page<MerchantProduct> findByMerchantIdAndStockQuantityLessThan(Long merchantId, Integer lowStockThreshold,
            Pageable pageable);
